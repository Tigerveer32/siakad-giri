          ...
          <form action="/insertdataguru" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
              <div class="col">
                ...
                <input type="text" name="id_guru" class="form-control" aria-label="First name" required>
              </div>
              <div class="col">
                <label for="inputEmail4" class="form-label">Nama Guru</label>
                <input type="text" name="nama_guru" class="form-control" aria-label="First name" required>
              </div>
            </div>
