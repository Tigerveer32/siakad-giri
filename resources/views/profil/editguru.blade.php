...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-7">
                <div class="card-body">
                    <form action="/updateguru"  method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-3"> 
                            <div class="col">
                                <label for="inputEmail4" class="form-label">Nama Lengkap</label>
                                <input type="text" name="nama_guru" class="form-control" aria-label="First name" value="{{ $data->nama_guru ?? '' }}" required>
                            </div>
                            <div class="col">
                        ...
                        <div class="row g-1">
                            <div class="col-12 mt-4">
                                ...
                                <a href="/profilguru" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
