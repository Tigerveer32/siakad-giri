          ...
          <div class="col-lg-4">
            <div class="card mb-4">
              <div class="card-body text-center">
                <img src="{{ asset('template/dist/img/user3-128x128.jpg' )}} " alt="avatar" class="img-fluid" style="width: 250px;">
                <h5 class="my-3">{{ $value->name}}</h5>

                <div class="mb-2 mb-lg-0">
                  <div class="body p-0">
                    <a href="/edit" class="btn btn-info btn-sm"><i class="fa fa-edit"> Edit Profil</i></a>
                  </div>
                </div>
            ...
            <div class="card mb-4">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <p class="text-muted mb-0">{{ $value->nama_siswa}}</p>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <p class="text-muted mb-0">{{ $value->nama_kelas}}</p>
                  </div>
                </div>
                <hr>
                <div class="row">
